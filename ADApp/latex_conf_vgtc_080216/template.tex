...
In order to zoom into a specific subset of data, analyst select the region (stack) he wants to zoom in (Figure ~\ref{fig:zoom}). Then the cell will be automatically updated showing that portion of data. 
