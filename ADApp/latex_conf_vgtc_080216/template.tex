...
3. Visual anomaly exploration, and timeline showcase: Time is a nice clue to understand the time-series data. Hence, we support the a visual timeline navigation to explore the abnormal data.    
